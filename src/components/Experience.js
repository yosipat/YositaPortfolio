    ...
    return (<>
        <div className='py-5' id="exp">
            <Container className='p-3'>
                ...
                <Row className=''>
                    <div className='p-3'>
                        <Card className='cardExp' style={{ borderRadius: "1rem" }}>
                            <Card.Header>
                        ...
                        <Card className='cardExp'>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <br />
                                    <small className=''>Developed an application for real-time monitoring and remote control of VFD machines and factory lighting systems via Modbus TCP/IP protocol, with a dashboard interface displaying live system status and control options.</small>
                                    <br /><br />
                        ...
                        <Card className='cardExp'>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    <small className='text-secondary'>[ SVI Public Company Limited ]</small>
                                    <br />
                                    <small className=''>Designed and developed a real-time air quality monitoring system to collect sensor data (e.g., PM2.5, temperature, humidity) with real-time dashboard and notifications windows pop-up. Implemented Over-the-Air (OTA) firmware updates to enable remote system maintenance and upgrades.</small>
                                    <br /><br />
                                    <Stack direction="horizontal" className='flex-wrap' gap={2}>
                                        <Badge pill bg="primary">Web App</Badge>
                                        <Badge pill bg="primary">Dashboard</Badge>
                        ...
                        <Card className='cardExp'>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    <small className='text-secondary'>[ SVI Public Company Limited ]</small>
                                    <br />
                                    <small className=''>Developed firmware for an EV charger to display real-time charging information (e.g., energy usage, charging time, status) on an LED screen and transmit charging data to a server using the Open Charge Point Protocol (OCPP) for logging and backend integration.</small>
                                    <br /><br />
                                    <Stack direction="horizontal" className='flex-wrap' gap={2}>
                                        <Badge pill bg="primary">Web App</Badge>
                                        <Badge pill bg="primary">C++</Badge>
