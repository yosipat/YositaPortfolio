...
function MyProject() {
    const cards = [
        ...
        { id: 2, img: Img_Workspace, title: "Shared Workspace Rental", detail: "A web application for coworking space rentals where owners can list and manage their properties using HTTP methods with JSON-based APIs, while users can browse and view property details.", type: "WebApp", frontend: ["Bootstrap"], backend: ["Node.js", "Express.js"], other: ["REST API"], github: "https://github.com/yosipat/SharedWorkspace_WebApp", demo: "https://sharedworkspace-webapp.onrender.com/" },
